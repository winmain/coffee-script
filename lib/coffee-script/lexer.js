...
(function() {
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.identifierToken = function() {
      var chunkRest, colon, colonOffset, forcedIdentifier, i, id, idLength, input, leftDel, length, match, poppedToken, prev, rightDel, tag, tagToken, _ref2, _ref3, _ref4;
      ...
      if (!forcedIdentifier && (__indexOf.call(JS_KEYWORDS, id) >= 0 || __indexOf.call(COFFEE_KEYWORDS, id) >= 0)) {
        ...
        if (tag === 'WHEN' && (_ref3 = this.tag(), __indexOf.call(LINE_BREAK, _ref3) >= 0)) {
          ...
          length += i;
          this.token('CAST', chunkRest.slice(1, i - 1), 0, length);
          return length;
        }
      }
