...
(function() {
  var Lexer, compile, ext, formatSourcePosition, fs, helpers, lexer, loadFile, parser, patchStackTrace, patched, path, sourcemap, vm, _i, _len, _ref,
  ...
  formatSourcePosition = function(frame, getSourceMapping) {
    var column, fileLocation, fileName, functionName, isConstructor, isMethodCall, line, methodName, source, tp, typeName, _as;
    fileName = void 0;
    fileLocation = '';
    if (frame.isNative()) {
      fileLocation = "native";
    ...
    if (isMethodCall) {
      ...
      if (functionName) {
        ...
        return "" + tp + functionName + _as + " (" + fileLocation + ")";
      } else {
