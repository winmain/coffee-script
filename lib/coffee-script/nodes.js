...
(function() {
  var Access, Arr, Assign, Base, Block, Call, Cast, Class, Closure, Code, CodeFragment, Comment, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Include, IncludeArg, Index, JsDocComment, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, Namespace, Obj, Op, Param, Parens, Provide, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, addLocationDataFn, addProvide, addRequire, bind, compact, del, ends, extend, flatten, fragmentsToText, hasProp, indexOf, last, locationDataToString, merge, multident, slice, some, starts, superClassReference, throwSyntaxError, unfoldSoak, utility, _ref, _ref1, _ref2, _ref3,
  ...
  exports.Block = Block = (function(_super) {
    ...
    Block.prototype.compileRoot = function(o) {
      var exp, fragments, i, name, namespace, prelude, preludeExps, provideFragments, rest, scopeFragments, scopedInclude, scopedIncludes, short, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref2, _ref3, _ref4;
      o.indent = o.bare ? '' : TAB;
      o.level = LEVEL_TOP;
      this.spaced = true;
      ...
      if (o.goog) {
        provideFragments = [];
        _ref3 = o.scope.getProvides();
        for (_j = 0, _len1 = _ref3.length; _j < _len1; _j++) {
          name = _ref3[_j];
          provideFragments.push(this.makeCode("goog.provide('" + name + "');\n"));
        }
        _ref4 = o.scope.getRequires();
        for (_k = 0, _len2 = _ref4.length; _k < _len2; _k++) {
          name = _ref4[_k];
          provideFragments.push(this.makeCode("goog.require('" + name + "');\n"));
        }
        scopedIncludes = o.scope.getScopedIncludes();
        if (scopedIncludes.length) {
          scopeFragments = [];
          for (_l = 0, _len3 = scopedIncludes.length; _l < _len3; _l++) {
            scopedInclude = scopedIncludes[_l];
            short = scopedInclude[0], namespace = scopedInclude[1];
            scopeFragments.push(this.makeCode("var " + short + " = " + namespace + ";\n"));
          }
          fragments = [].concat(this.makeCode("goog.scope(function() {\n"), scopeFragments, fragments, this.makeCode("});"));
        }
  ...
  exports.Cast = Cast = (function(_super) {
    ...
    Cast.prototype.isAssignable = NO;

    Cast.prototype.isComplex = NO;

    Cast.prototype.compileNode = function(o) {
      return [this.makeCode("/** @type {" + this.value + "} */")];
    };
  ...
  exports.JsDocComment = JsDocComment = (function(_super) {

    __extends(JsDocComment, _super);

    JsDocComment.knownAnnotations = ['constructor', 'type', 'extends'];

    function JsDocComment(lines) {
      var key, line, _i, _len, _ref4;
      this.annotations = {};
      this.lines = [];
      for (_i = 0, _len = lines.length; _i < _len; _i++) {
        ...
        if (line.annotation) {
          ...
          this.annotations[key].push(line.params);
          if (key === '@attr') {
            key = '@param';
          }
          if (_ref4 = line.annotation, __indexOf.call(JsDocComment.knownAnnotations, _ref4) < 0) {
            this.lines.push("" + key + " " + (line.params.join(" ")));
          }
        } else {
    ...
    JsDocComment.prototype.isStatement = YES;

    JsDocComment.prototype.makeReturn = THIS;

    JsDocComment.prototype.compileNode = function(o, level) {
      var annotationFragments, annotationName, fragments, key, line, params, separator, _i, _j, _len, _len1, _ref4, _ref5;
      annotationFragments = [];
      _ref4 = JsDocComment.knownAnnotations;
      for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
        annotationName = _ref4[_i];
        key = "@" + annotationName;
        if (this.annotations[key] != null) {
          _ref5 = this.annotations[key];
          for (_j = 0, _len1 = _ref5.length; _j < _len1; _j++) {
            params = _ref5[_j];
            annotationFragments.push(this.makeCode("" + key + " " + (params.join(" ")) + "\n"));
          }
        }
      }
      if (this.lines.length + annotationFragments.length > 1) {
        separator = '\n';
      } else {
        separator = '';
      }
      fragments = [].concat(this.makeCode("/**" + separator), (function() {
        var _k, _len2, _ref6, _results;
        _ref6 = this.lines;
        _results = [];
        for (_k = 0, _len2 = _ref6.length; _k < _len2; _k++) {
          line = _ref6[_k];
          _results.push(this.makeCode(line + separator));
        }
        return _results;
      }).call(this), annotationFragments, this.makeCode('*/'));
      return fragments;
    };
  ...
  exports.Include = Include = (function(_super) {
    ...
    Include.prototype.isStatement = function() {
      return true;
    };

    Include.prototype.compileNode = function(o) {
      var pack, _i, _len, _ref4;
      _ref4 = this.packages;
      for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
        pack = _ref4[_i];
        pack.compile(o);
  ...
  exports.Provide = Provide = (function(_super) {

    __extends(Provide, _super);

    function Provide(packages) {
      this.packages = packages;
    }

    Provide.prototype.isStatement = function() {
      return true;
    };

    Provide.prototype.compileNode = function(o) {
      var pack, _i, _len, _ref4;
      _ref4 = this.packages;
      for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
        pack = _ref4[_i];
        addProvide(pack.compile(o));
      }
      return [];
    };
  ...
  exports.IncludeArg = IncludeArg = (function(_super) {

    __extends(IncludeArg, _super);

    function IncludeArg(include, short) {
      this.include = include;
      this.short = short;
    }

    IncludeArg.prototype.compileNode = function(o) {
      var _ref4;
      addRequire(this.include.compile(o), (_ref4 = this.short) != null ? _ref4.compile(o) : void 0);
      return [];
    };
  ...
  exports.Namespace = Namespace = (function(_super) {
    ...
    function Namespace(identifier, parent) {
    ...
    Namespace.prototype.compileNode = function(o) {
      ...
      code = '';
      if (this.parent) {
        code += this.parent.compile(o) + '.';
      }
      code += this.identifier.compile(o);
      return [this.makeCode(code)];
    };
  ...
  exports.Call = Call = (function(_super) {
    ...
    Call.prototype.superReference = function(o) {
      ...
      if (method != null ? method.klass : void 0) {
        ...
        return "" + method.name + "." + (superClassReference(o)) + ".constructor";
      } else {
    ...
    Call.prototype.compileNode = function(o) {
      var action, arg, argIndex, compiledArgs, compiledArray, compiled_variable, fragments, namespace_arg, preface, _i, _len, _ref4, _ref5;
      if (o.goog && this.variable instanceof exports.Value && this.variable.base instanceof exports.Literal && this.variable.base.value === 'goog') {
        compiled_variable = this.variable.compile(o);
        action = {
          'goog.require': addRequire,
          'goog.provide': addProvide
        }[compiled_variable];
        if (action != null) {
          namespace_arg = this.args[0].compile(o).slice(1, -1);
  ...
  exports.Class = Class = (function(_super) {
    ...
    Class.prototype.addBoundFunctions = function(o) {
      ...
      for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
        ...
        this.ctor.body.unshift(new Literal("" + lhs + " = " + (bind(o)) + "(" + lhs + ", this)"));
      }
    };

    Class.prototype.addProperties = function(node, name, o, jsDoc) {
          ...
          if (assign instanceof Assign) {
            ...
            if (base.value === 'constructor') {
              ...
              if (func instanceof Code) {
                this.ctor = func;
                this.ctor.jsDoc = jsDoc;
                this.ctorBlock = new Block([this.ctor]);
                assign = o.goog ? false : this.ctorBlock;
              } else {
    ...
    Class.prototype.walkBody = function(name, o) {
      ...
      return this.traverseChildren(false, function(child) {
        var cont, exps, i, node, _i, _len, _ref4, _ref5;
        cont = true;
        ...
        if (child instanceof Block) {
          ...
          for (i = _i = 0, _len = _ref4.length; _i < _len; i = ++_i) {
            node = _ref4[i];
            if (o.goog && node instanceof JsDocComment && (child.expressions[i + 1] != null)) {
              exps[i] = [];
              exps[i + 1].jsDoc = node;
              continue;
            }
            if (node instanceof Value && node.isObject(true)) {
              cont = false;
              exps[i] = _this.addProperties(node, name, o, node.jsDoc);
            } else if (node.jsDoc) {
              _ref5 = [node.jsDoc, void 0], exps[i - 1] = _ref5[0], node.jsDoc = _ref5[1];
            }
          }
    ...
    Class.prototype.ensureConstructor = function(name, fullname, o) {
      var missing, ref, superCall, _base;
      missing = !this.ctor;
      this.ctor || (this.ctor = new Code);
      this.ctor.ctor = this.ctor.name = fullname;
      this.ctor.klass = null;
      this.ctor.noReturn = true;
      this.ctorBlock = new Block([this.ctor]);
      if (missing) {
        if (this.parent) {
          superCall = new Literal("" + fullname + "." + (superClassReference(o)) + ".constructor.apply(this, arguments)");
        }
        ...
        if (superCall && o.goog) {
          this.ctor.body.unshift(superCall);
        }
        ...
        if (!o.goog) {
          this.body.expressions.unshift(this.ctorBlock);
        }
      } else {
        this.addBoundFunctions(o);
      }
      if (o.goog) {
        (_base = this.ctor).jsDoc || (_base.jsDoc = new JsDocComment([]));
        this.ctorBlock.unshift(this.ctor.jsDoc);
        this.ctor.jsDoc.annotations['@constructor'] = [[]];
      }
      if (o.goog && this.parent) {
        this.ctorBlock.push(new Literal("goog.inherits(" + fullname + ", " + (this.parent.compile(o)) + ")"));
        this.ctor.jsDoc.annotations['@extends'] = [[this.parent.compile(o)]];
      }
      if (o.goog && name !== fullname) {
        return this.ctorBlock.push(new Literal("var " + name + " = " + fullname));
      }
    };

    Class.prototype.compileNode = function(o) {
      var call, decl, fullname, klass, lname, name, params, _ref4;
      ...
      fullname = o.goog ? this.variable.compile(o) : name;
      this.hoistDirectivePrologue();
      this.setContext(fullname);
      this.walkBody(fullname, o);
      this.ensureConstructor(name, fullname, o);
      if (o.goog) {
        this.body.expressions.unshift(this.ctorBlock);
      }
      ...
      if (o.goog) {
        addProvide(this.variable.compile(o));
        if (this.parent) {
          addRequire(this.parent.compile(o));
        }
      }
      if (o.goog) {
        return [this.makeCode("goog.scope(function(){\n" + (this.body.compile(o)) + "\n})")];
      } else {
  ...
  exports.Assign = Assign = (function(_super) {
    ...
    Assign.prototype.compileNode = function(o) {
      var answer, compiledName, isValue, jsDoc, match, name, val, varBase, _ref4, _ref5, _ref6, _ref7;
      jsDoc = [];
      if (this.jsDoc) {
        jsDoc = this.jsDoc.compileToFragments(o);
        jsDoc.push(this.makeCode('\n'));
      }
      if (isValue = this.variable instanceof Value) {
        if (this.variable.isArray() || this.variable.isObject()) {
          return jsDoc.concat(this.compilePatternMatch(o));
        }
        if (this.variable.isSplice()) {
          return jsDoc.concat(this.compileSplice(o));
        }
        if ((_ref4 = this.context) === '||=' || _ref4 === '&&=' || _ref4 === '?=') {
          return jsDoc.concat(this.compileConditional(o));
        }
      }
      ...
      if (this.context === 'object') {
        return jsDoc.concat(compiledName.concat(this.makeCode(": "), val));
      }
      answer = compiledName.concat(this.makeCode(" " + (this.context || '=') + " "), val);
      if (o.level <= LEVEL_LIST) {
        return jsDoc.concat(answer);
      } else {
        return jsDoc.concat(this.wrapInBraces(answer));
      }
    };
  ...
  exports.Splat = Splat = (function(_super) {
    ...
    Splat.compileSplattedArray = function(o, list, apply) {
      ...
      for (i = _i = 0, _len = args.length; _i < _len; i = ++_i) {
        ...
        args[i] = node instanceof Splat ? [].concat(node.makeCode("" + (slice(o)) + "("), compiledNode, node.makeCode(")")) : [].concat(node.makeCode("["), compiledNode, node.makeCode("]"));
      }
      if (index === 0) {
        node = list[0];
  ...
  exports.In = In = (function(_super) {
    ...
    In.prototype.compileLoopTest = function(o) {
      ...
      fragments = [].concat(this.makeCode(indexOf(o) + "("), this.array.compileToFragments(o, LEVEL_LIST), this.makeCode(", "), ref, this.makeCode(") " + (this.negated ? '< 0' : '>= 0')));
  ...
  exports.For = For = (function(_super) {
    ...
    For.prototype.compileNode = function(o) {
      ...
      if (this.object) {
        ...
        if (this.own) {
          guardPart = "\n" + idt1 + "if (!" + (hasProp(o)) + "(" + svar + ", " + kvar + ")) continue;";
        }
      }
  ...
  superClassReference = function(o) {
    if (o.goog) {
      return 'superClass_';
    } else {
      return '__super__';
  ...
  addProvide = function(name) {
    return Scope.root.provide(name);
  };

  addRequire = function(name, short) {
    return Scope.root.require(name, short);
  };
