...
(function() {
  var Access, Arr, Assign, Base, Block, Call, Class, Closure, Code, Comment, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, addLocationDataFn, addProvide, addRequire, bind, compact, del, ends, extend, flatten, hasProp, indexOf, last, locationDataToString, merge, multident, slice, some, starts, superClassReference, unfoldSoak, utility, _ref, _ref1,
  ...
  exports.Block = Block = (function(_super) {
    ...
    Block.prototype.compileRoot = function(o) {
      var code, exp, i, name, prelude, preludeExps, provideCode, rest, _i, _j, _len, _len1, _ref2, _ref3;
      o.indent = o.bare ? '' : TAB;
  ...
  addRequire = function(name) {
    return Scope.root.require(name);
  };
