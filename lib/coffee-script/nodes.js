...
(function() {
  ...
  exports.Block = Block = (function(_super) {
    ...
    Block.prototype.compileRoot = function(o) {
      var exp, fragments, i, name, namespace, prelude, preludeExps, provideFragments, rest, scopeFragments, scopedInclude, scopedIncludes, short, _i, _j, _k, _len, _len1, _len2, _ref2, _ref3;
      o.indent = o.bare ? '' : TAB;
      ...
      if (o.goog) {
        ...
        if (scopedIncludes.length) {
          scopeFragments = [];
          for (_k = 0, _len2 = scopedIncludes.length; _k < _len2; _k++) {
            scopedInclude = scopedIncludes[_k];
