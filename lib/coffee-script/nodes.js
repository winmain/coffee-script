...
(function() {
  ...
  exports.JsDocComment = JsDocComment = (function(_super) {
    ...
    JsDocComment.singleAnnotations = ['constructor', 'type', 'extends'];
    ...
    function JsDocComment(lines) {
      ...
      for (_i = 0, _len = lines.length; _i < _len; _i++) {
        line = lines[_i];
        if (line.annotation) {
          if (_ref4 = line.annotation, __indexOf.call(JsDocComment.singleAnnotations, _ref4) >= 0) {
            this.annotations["@" + line.annotation] = line.params;
          } else {
    ...
    JsDocComment.prototype.compileNode = function(o, level) {
      var annotation, annotationFragments, fragments, line, separator, _i, _len, _ref4;
      annotationFragments = [];
      _ref4 = JsDocComment.singleAnnotations;
      for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
        annotation = _ref4[_i];
        if (this.annotations["@" + annotation] != null) {
          annotationFragments.push(this.makeCode("@" + annotation + " " + (this.annotations["@" + annotation].join(" ")) + "\n"));
        }
      }
