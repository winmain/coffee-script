      ...
      for (_i = 0, _len = lines.length; _i < _len; _i++) {
        ...
        if (line.annotation) {
          if (_ref4 = line.annotation, __indexOf.call(JsDocComment.singleAnnotations, _ref4) >= 0) {
            this.annotations["@" + line.annotation] = line.value;
          } else {
            this.lines.push("@" + line.annotation + " " + line.value);
          }
        } else {
    ...
    JsDocComment.prototype.compileNode = function(o, level) {
      ...
      for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
        ...
        if (this.annotations["@" + annotation] != null) {
          annotationFragments.push(this.makeCode("@" + annotation + " " + this.annotations["@" + annotation] + "\n"));
        }
      }
