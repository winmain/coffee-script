  ...
  exports.Class = Class = (function(_super) {
    ...
    Class.prototype.ensureConstructor = function(name, fullname, o) {
      ...
      if (o.goog && name !== fullname) {
        this.ctorBlock.push(new Literal("var " + name + " = " + fullname));
      }
      if (o.goog && this.ctor.jsDoc) {
        return this.ctorBlock.unshift(this.ctor.jsDoc);
      }
    };
