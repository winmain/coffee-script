...
(function() {
  var Access, Arr, Assign, Base, Block, Call, Class, Closure, Code, Comment, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Include, IncludeArg, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, Namespace, Obj, Op, Param, Parens, Provide, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, addLocationDataFn, addProvide, addRequire, compact, del, ends, extend, flatten, hasProp, indexOf, last, locationDataToString, merge, multident, slice, some, starts, superClassReference, unfoldSoak, utility, _ref, _ref1,
  ...
  exports.Block = Block = (function(_super) {
    ...
    Block.prototype.compileRoot = function(o) {
      var code, exp, i, name, namespace, prelude, preludeExps, provideCode, rest, scopeCode, scopedInclude, scopedIncludes, short, _i, _j, _k, _len, _len1, _len2, _ref2, _ref3;
      o.indent = o.bare ? '' : TAB;
  ...
  exports.IncludeArg = IncludeArg = (function(_super) {
    ...
    IncludeArg.prototype.compileNode = function(o) {
      var _ref2;
      addRequire(this.include.compile(o), (_ref2 = this.short) != null ? _ref2.compile(o) : void 0);
      return '';
    };
  ...
  exports.Call = Call = (function(_super) {
    ...
    Call.prototype.compileNode = function(o) {
      var action, arg, args, code, compiled_variable, namespace_arg, _ref2;
  ...
  exports.Class = Class = (function(_super) {
    ...
    Class.prototype.ensureConstructor = function(name, fullname, o) {
      if (!this.ctor) {
        this.ctor = new Code;
        if (this.parent) {
          this.ctor.body.push(new Literal("" + fullname + "." + (superClassReference(o)) + ".constructor.apply(this, arguments)"));
        }
    ...
    Class.prototype.compileNode = function(o) {
      var call, decl, fullname, klass, lname, name, params, _ref2;
  ...
  exports.Splat = Splat = (function(_super) {
    ...
    Splat.compileSplattedArray = function(o, list, apply) {
      ...
      for (i = _i = 0, _len = args.length; _i < _len; i = ++_i) {
        ...
        args[i] = node instanceof Splat ? "" + (slice(o)) + "(" + code + ")" : "[" + code + "]";
      }
      if (index === 0) {
  ...
  exports.In = In = (function(_super) {
    ...
    In.prototype.compileLoopTest = function(o) {
      ...
      code = indexOf(o) + ("(" + (this.array.compile(o, LEVEL_LIST)) + ", " + ref + ") ");
  ...
  exports.If = If = (function(_super) {
    ...
    If.prototype.compileStatement = function(o) {
      var body, child, cond, exeq, ifPart, indent;
      ...
      indent = o.indent + TAB;
      body = this.ensureBlock(this.body).compile(merge(o, {
        indent: indent
      }));
      ...
      return ifPart + ' else ' + (this.isChain ? (o.chainChild = true, this.elseBody.unwrap().compile(o, LEVEL_TOP)) : "{\n" + (this.elseBody.compile(merge(o, {
        indent: indent
      }), LEVEL_TOP)) + "\n" + this.tab + "}");
    };
