  ...
  exports.Class = Class = (function(_super) {
          ...
          if (assign instanceof Assign) {
            ...
            if (base.value === 'constructor') {
              ...
              if (func instanceof Code) {
                this.ctor = func;
                assign = this.ctorBlock = new Block([this.ctor]);
              } else {
    ...
    Class.prototype.ensureConstructor = function(name, o) {
      if (!this.ctor) {
        this.ctor = new Code;
        if (this.parent) {
          this.ctor.body.push(new Literal("" + name + "." + (superClassReference(o)) + ".constructor.apply(this, arguments)"));
        }
      ...
      if (o.goog && this.parent) {
        return this.ctorBlock.push(new Literal("goog.inherits(" + name + ", " + (this.parent.compile(o)) + ")"));
      }
    };
    ...
    Class.prototype.compileNode = function(o) {
      ...
      this.ensureConstructor(fullname, o);
